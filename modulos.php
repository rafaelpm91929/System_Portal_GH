...
if (!isset($CATALOGO_AGENCIAS[$agencia_key])) {
    $agencia_key = 'divolavilla';
}

$info_agencia = $CATALOGO_AGENCIAS[$agencia_key];
...
<head>
    ...
    <title>Módulos de Sistemas - <?php echo htmlspecialchars($info_agencia['nombre']); ?></title>
...
<div class="top-navbar d-flex justify-content-between align-items-center">
    ...
    <div class="d-flex align-items-center gap-3">
        <div class="text-end d-none d-md-block">
            ...
            <div class="text-secondary" style="font-size: 0.75rem;"><?php echo htmlspecialchars($info_agencia['nombre']); ?></div>
        </div>
...
<div class="header-section">
    <div class="master-badge"><i class="bi <?php echo $info_agencia['icono']; ?>"></i> SUCURSAL SELECCIONADA</div>
    <h1 class="header-title"><?php echo htmlspecialchars($info_agencia['nombre']); ?></h1>
...
<div class="modules-grid">
    ...
    <div class="module-card">
        ...
        <a href="reportes.php?agencia=<?php echo $agencia_key; ?>" class="btn-ingresar">Ingresar</a>
    </div>
    ...
    <div class="module-card">
        ...
        <a href="reportes.php?agencia=<?php echo $agencia_key; ?>&modulo=equipos" class="btn-ingresar">Ingresar</a>
    </div>
