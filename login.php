...
<head>
    ...
    <title>Iniciar Sesión - Portal Maestro Grupo Huerta</title>
...
<div class="login-wrapper">
    ...
    <div class="hero-section d-none d-md-block">
        ...
        <h1 class="hero-title">Portal Maestro de Sistemas</h1>
        <p class="hero-desc">
            Tablero centralizado de control de agencias y sucursales del Grupo Huerta.
        </p>
        <div class="feature-badge">
            <i class="bi bi-shield-check"></i> Acceso Maestro Cifrado
        </div>
    </div>
        ...
        <form method="POST" action="login.php">
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="usuario" id="usuario" class="form-control form-control-custom" placeholder="ej. admin" required autofocus>
                </div>
            </div>
            ...
            <button type="submit" class="btn-submit">
                <i class="bi bi-box-arrow-in-right me-2"></i> Ingresar al Portal Maestro
            </button>
        </form>
    </div>
